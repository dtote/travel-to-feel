  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-0 m-0">
      ...
      <div className="w-full flex flex-col items-center justify-center mt-8">
        ...
        <p className="w-4/5 sm:w-1/2 md:w-[50vw] lg:w-[50vw] text-justify lg:text-center text-base md:text-xl">
        ...
        <div className="w-4/5 sm:w-1/2 md:w-[50vw] lg:w-[50vw] h-[30vh] sm:h-[60vh] md:h-[65vh] lg:h-[60vh] relative mt-8">
            <Image
      ...
      <div className="w-full flex flex-col items-center justify-center mt-8">
        ...
        <p className="w-4/5 sm:w-1/2 md:w-[50vw] lg:w-[50vw] text-justify text-base md:text-xl">
